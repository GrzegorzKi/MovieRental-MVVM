...
public class RangeObservableCollection<T> : ObservableCollection<T> {
    ...
    internal EqualityComparer<T>? _comparer;
    ...
    /// </summary>
    internal void OnEssentialPropertiesChanged() {
    ...
    /// /// </summary>
    internal void OnIndexerPropertyChanged() =>
    ...
    internal void OnRangeReplaced(int followingItemIndex, ICollection<T> newCluster, ICollection<T> oldCluster) {
